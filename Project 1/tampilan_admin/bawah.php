<?php
include_once 'bagian_web/atas.php';
?>
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="variabel_user" class="nav-link active">
                      <i class="nav-icon fas fa-code"></i>
                      <p>Variabel User</p>
                    </a>
                  </li>
      ...
      <div class="card">
        <div class="card-body row">
          <div class="d-flex row">
            <div class="card-body">
            <footer>
              <p>Create by mahasiswa <a href="https://elena.nurulfikri.ac.id" target="_blank">STT NF</a>2021</p>
            </footer>
            </div>
          </div>
        </div>
...
<?php
require_once 'bagian_web/bawah.php';
?>