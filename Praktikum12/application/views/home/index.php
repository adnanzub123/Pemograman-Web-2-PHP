          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse sub-menu-bar" id="navbarNine">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url("index.php/mahasiswa/index")?>">Mahasiswa</a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url("index.php/dosen/index")?>">Dosen</a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url("index.php/matakuliah/index")?>">Matakuliah</a>
                </li>
                <li class="nav-item">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-12 col-12">
          <div class="header-image">
            <img src="<?php echo base_url('asets/kampus.jpg')?>" alt="#" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-12">
          <div class="about-image-five">
            ...
            <img src="<?php echo base_url('asets/sttnf-logo.png')?>" alt="about" />
          </div>
        </div>
        <div class="col-lg-6 col-12">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
              ...
              <div class="footer-widget f-about">
                <div class="logo">
                  <a href="index.html">
                  <img src="<?php echo base_url('asets/sttnf-logo.png')?>" alt="#" class="img-fluid" width="200px" height="50px" />
                  </a>
                </div>
                <p>
                  Kuliah? STT-NF Aja
  ...
  <!--/ End Footer Area -->
	...
	<div class="made-in-ayroui mt-4">
		<a href="https://admisi.nurulfikri.ac.id/" target="_blank" rel="nofollow">
		  <img style="width:80px" src="<?php echo base_url('asets/sttnf-logo.png')?>">
		</a>
	</div>
